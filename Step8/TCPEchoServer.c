...
int main(int argc, char *argv[])
{
    ...
    else
    {
	      ...
	      ipAdress = inet_ntoa(echoServAddr.sin_addr) ;
    ...
    for (;;) /* Run forever */
    {
        ...
        getnameinfo((struct sockaddr *)&echoClntAddr,clntLen, host, NI_MAXHOST, port, NI_MAXSERV, NI_NUMERICSERV | NI_NUMERICHOST);
